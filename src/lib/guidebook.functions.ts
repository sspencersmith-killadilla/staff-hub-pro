...
// (Legacy magazine-style server fn removed — see the client-side Guidebook
// Publisher at /staff/admin/guidebook-publisher which generates PDFs via
// @react-pdf/renderer for true WYSIWYG output.)
